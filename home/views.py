...
class HomeView(View):
	...
	post_form_class = PostCreateUpdateForm
	...
	def get(self, request,*args, **kwargs):
		...
		return render(request, 'home/index.html', {'posts':posts, 'form':self.form_class, 'create_post':self.post_form_class})
	...
	def post(self, request, *args, **kwargs):
		if request.user.is_authenticated:
			...
			messages.error(request, 'you have to log in first', 'danger')
